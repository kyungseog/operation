...
const rule15 = new util.lib.schedule.RecurrenceRule();
rule15.dayOfWeek = [0, 1, 2, 3, 4, 5, 6];
rule15.minute = 15;
util.lib.schedule.scheduleJob("jpSales15", rule15, () => controlOrderUpdate());

const rule45 = new util.lib.schedule.RecurrenceRule();
rule45.dayOfWeek = [0, 1, 2, 3, 4, 5, 6];
rule45.minute = 45;
util.lib.schedule.scheduleJob("jpSales45", rule45, () => controlOrderUpdate());

async function controlOrderUpdate() {
