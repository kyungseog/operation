...
async function estimateTemperature() {
  ...
  let uploadData = [
    ['KR', 'seoul', DateTime.now().plus({days: 3}).toFormat('yyyy-LL-dd'), tempArray[0].taMin3, tempArray[0].taMax3, rainArray[0].rnSt3Am, rainArray[0].rnSt3Pm],
    ['KR', 'seoul', DateTime.now().plus({days: 4}).toFormat('yyyy-LL-dd'), tempArray[0].taMin4, tempArray[0].taMax4, rainArray[0].rnSt4Am, rainArray[0].rnSt4Pm],
    ['KR', 'seoul', DateTime.now().plus({days: 5}).toFormat('yyyy-LL-dd'), tempArray[0].taMin5, tempArray[0].taMax5, rainArray[0].rnSt5Am, rainArray[0].rnSt5Pm],
    ['KR', 'seoul', DateTime.now().plus({days: 6}).toFormat('yyyy-LL-dd'), tempArray[0].taMin6, tempArray[0].taMax6, rainArray[0].rnSt6Am, rainArray[0].rnSt6Pm],
    ['KR', 'seoul', DateTime.now().plus({days: 7}).toFormat('yyyy-LL-dd'), tempArray[0].taMin7, tempArray[0].taMax7, rainArray[0].rnSt7Am, rainArray[0].rnSt7Pm],
  ];
